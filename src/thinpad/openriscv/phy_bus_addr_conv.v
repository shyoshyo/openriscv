...
`define UART_PHYSICAL_ADDR_BEGIN           34'h010013000
...
`define FLASH_PHYSICAL_ADDR_BEGIN          34'h02000_0000
`define FLASH_PHYSICAL_ADDR_LEN            34'h00100_0000
...
module phy_bus_addr_conv(
	...
	wire [`PhyAddrBus] sram_index = ((phy_addr_i - `SRAM_PHYSICAL_ADDR_BEGIN));
	...
	always @(*)
		...
		begin
			if (sram_index < `SRAM_PHYSICAL_ADDR_LEN)
				bus_addr_o <= {4'h0, sram_index[27:0]};
